...
ledger_width = int(1.5*staff_width)
ledger_radius = int(1.5*space_unit)
...
_attributes = ['c','k','p','d', 'o', 'dir', 'num'] + _positions
##############clef,key,pitch,duration,onset,direction,number,positions

_flags = ['system', 'staff', 'measure'] + _symbols + _attributes
_hierarchy = [('system','staff'), ('staff','measure'), ('measure', 'beam'), ('measure', 'beam'), ('measure', 'chord'), ('measure', 'clef'), ('clef','key'), ('clef', 'time'), ('beam', 'chord'), ('measure','rest')]
...
solid_offset = {
    ...
    "whole_note_head":[int(-2*font_size),int(-font_size/7)],
